...
import { useDeleteBarangMasuk } from "../../api/delete-barang-masuk";

export default function ButtonDeleteBarangMasuk({ id }: { id: string }) {
    ...
    const deleteMutation = useDeleteBarangMasuk({});
