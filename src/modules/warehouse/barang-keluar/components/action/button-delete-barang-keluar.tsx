...
import { useDeleteBarangKeluar } from "../../api/delete-barang-keluar";

export default function ButtonDeleteBarangKeluar({ id }: { id: string }) {
    ...
    const deleteMutation = useDeleteBarangKeluar({});
