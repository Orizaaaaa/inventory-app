...
export default function UpdatePreOrderModal({
    open,
    onOpenChange,
    preOrder,
        ...
        modalConfirm.handleConfirm({
            ...
            onSubmit: async () => {
                try {
                    ...
                    console.log("Update pre-order:", { id: preOrderId, data: formValues });
                    ...
                    modalConfirm.hideModal();
                    const message = error instanceof Error ? error.message : "Failed to update pre-order.";
