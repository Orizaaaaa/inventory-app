...
interface UpdateBahanBakuModalProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    bahanBaku: BahanBakuType;
}

export default function UpdateBahanBakuModal({
    open,
    onOpenChange,
    bahanBaku,
}: UpdateBahanBakuModalProps) {
    const bahanBakuId = bahanBaku.id || bahanBaku._id || "";
    ...
    const {
        ...
        defaultValues: {
            ...
            code: bahanBaku?.code || "",
            unit: bahanBaku?.unit || "",
            stock: bahanBaku?.stock || 0,
            location: bahanBaku?.location || "",
        ...
        modalConfirm.handleConfirm({
            ...
            onSubmit: async () => {
                try {
                    ...
                    console.log("Update bahan baku:", { id: bahanBakuId, data: formValues });
                    ...
                    modalConfirm.hideModal();
                    const message = error instanceof Error ? error.message : "Failed to update bahan baku.";
